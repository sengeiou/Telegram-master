...
import org.telegram.utils.folder.FolderIconHelper;
...
public class FilterTabsView extends FrameLayout {
    ...
    private class Tab {
        ...
        public Tab(int i, String t, String e) {
            id = i;
            title = TelephConfig.tabsTitleType != TelephConfig.TITLE_TYPE_ICON ? t : "";
        ...
        public boolean setTitle(String newTitle) {
            newTitle = TelephConfig.tabsTitleType != TelephConfig.TITLE_TYPE_ICON ? newTitle : "";
    ...
    public class TabView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (TelephConfig.tabsTitleType != TelephConfig.TITLE_TYPE_ICON) {
            ...
            int iconX = 0;
            if (TelephConfig.tabsTitleType != TelephConfig.TITLE_TYPE_TEXT) {
...
//                    Log.e("FilterTAbs", getDrawable(FolderIconHelper.getTabIcon(currentTab.emoticon, true))+"");
            ...
            if (animateCounterEnter || counterText != null || currentTab.id != Integer.MAX_VALUE && (isEditing || editingStartAnimationProgress != 0)) {
                ...
                int textSpace = TelephConfig.tabsTitleType != TelephConfig.TITLE_TYPE_ICON ? AndroidUtilities.dp(6) : 0;
...
//            if (!isEditing || (!TelephConfig.hideAllTab && viewHolder.getAdapterPosition() == 0)) {
...
//            if (!TelephConfig.hideAllTab && (source.getAdapterPosition() == 0 || target.getAdapterPosition() == 0)) {
