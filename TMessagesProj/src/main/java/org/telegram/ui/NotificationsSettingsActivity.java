...
public NotificationsSettingsActivity(){
    ...
    public void SettingsSelf(Context context){

//        Log.e("SettingsSelf","group-"+groupRow+", channels-"+channelsRow);
        adapter = new ListAdapter(context);


        //关闭群组  频道
//        getNotificationsController().setGlobalNotificationsEnabled(NotificationsController.TYPE_GROUP, Integer.MAX_VALUE);
//        adapter.notifyItemChanged(privateRow);
        getNotificationsController().setGlobalNotificationsEnabled(NotificationsController.TYPE_GROUP, Integer.MAX_VALUE);
        adapter.notifyItemChanged(groupRow);
        getNotificationsController().setGlobalNotificationsEnabled(NotificationsController.TYPE_CHANNEL, Integer.MAX_VALUE);
        adapter.notifyItemChanged(channelsRow);
        //应用内通知优先级
        SharedPreferences preferences = MessagesController.getNotificationsSettings(currentAccount);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean("EnableInAppPriority", true);
        editor.commit();
        //后台通知服务
        ...
        //通知 徽标数字 开启
        editor.putBoolean("PinnedMessages", true);
        editor.commit();
        editor.putBoolean("EnableAutoNotifications", true);
        editor.commit();
        getNotificationsController().showBadgeNumber = true;
        editor.putBoolean("badgeNumber", getNotificationsController().showBadgeNumber);
        editor.commit();
        getNotificationsController().updateBadge();
        getNotificationsController().showBadgeMuted = true;
        editor.putBoolean("badgeNumberMuted", getNotificationsController().showBadgeMuted);
        editor.commit();
        getNotificationsController().updateBadge();
        getMessagesStorage().updateMutedDialogsFiltersCounters();
        getNotificationsController().showBadgeMessages = true;
        ...
        //设置所有登录账号 消息通知
        editor.putBoolean("AllAccounts", true);
        editor.commit();
